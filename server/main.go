...
func main() {
	...
	scriptWsHandler := execution.NewScriptHandler(scriptLoader, cfg)
	...
	protected.GET("/pipelines/export", apiHandler.ExportPipelines)
	protected.POST("/pipelines/import", apiHandler.ImportPipelines)
	protected.POST("/pipelines", apiHandler.CreatePipeline)
	protected.GET("/pipelines/:id", apiHandler.GetPipeline)
	protected.GET("/pipelines/:id/raw", apiHandler.GetPipelineRaw)
	protected.PUT("/pipelines/:id", apiHandler.UpdatePipeline)
	protected.DELETE("/pipelines/:id", apiHandler.DeletePipeline)
	protected.GET("/git/branches", apiHandler.GitBranches)
	protected.GET("/scripts", apiHandler.ListScripts)
	protected.GET("/scripts/export", apiHandler.ExportScripts)
	protected.POST("/scripts", apiHandler.CreateScript)
	protected.GET("/scripts/:id", apiHandler.GetScript)
	protected.PUT("/scripts/:id", apiHandler.UpdateScript)
	protected.DELETE("/scripts/:id", apiHandler.DeleteScript)
	...
	protected.POST("/me/api-keys", apiHandler.CreateMyAPIKey)
